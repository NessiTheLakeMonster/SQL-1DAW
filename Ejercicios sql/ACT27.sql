...
INSERT INTO pedido VALUES (1,TO_DATE('2006-01-17', 'YYYY-MM-DD'),TO_DATE('2006-01-19', 'YYYY-MM-DD'),TO_DATE('2006-01-19', 'YYYY-MM-DD'),'Entregado','Pagado a plazos',5);
...
INSERT INTO pedido VALUES (29,TO_DATE('2008-08-01', 'YYYY-MM-DD'),TO_DATE('2008-09-01', 'YYYY-MM-DD'),TO_DATE('2008-09-01', 'YYYY-MM-DD'),'Rechazado','El cliente no está conforme con el pedido',14);
...
INSERT INTO pedido VALUES (48,TO_DATE('2008-03-17', 'YYYY-MM-DD'),TO_DATE('2008-03-30', 'YYYY-MM-DD'),TO_DATE('2008-03-29', 'YYYY-MM-DD'),'Entregado','Según el Cliente, el pedido llegó defectuoso',26);
INSERT INTO pedido VALUES (49,TO_DATE('2008-07-12', 'YYYY-MM-DD'),TO_DATE('2008-07-22', 'YYYY-MM-DD'),TO_DATE('2008-07-30', 'YYYY-MM-DD'),'Entregado','El pedido llegó 1 día tarde, pero no hubo queja por parte de la empresa compradora',26);
INSERT INTO pedido VALUES (50,TO_DATE('2008-03-17', 'YYYY-MM-DD'),TO_DATE('2008-08-09', 'YYYY-MM-DD'),NULL,'Pendiente','Al parecer, el pedido se ha extraviado a la altura de Sotalbo (Ávila)',26);
INSERT INTO pedido VALUES (51,TO_DATE('2008-10-01', 'YYYY-MM-DD'),TO_DATE('2008-10-14', 'YYYY-MM-DD'),TO_DATE('2008-10-14', 'YYYY-MM-DD'),'Entregado','Todo se entregó a tiempo y en perfecto estado, a pesar del pésimo estado de las carreteras.',26);
INSERT INTO pedido VALUES (52,TO_DATE('2008-12-07', 'YYYY-MM-DD'),TO_DATE('2008-12-21', 'YYYY-MM-DD'),NULL,'Pendiente','El transportista ha llamado a Eva María para indicarle que el pedido llegará más tarde de lo esperado.',26);
...
INSERT INTO pedido VALUES (60,TO_DATE('2009-01-22', 'YYYY-MM-DD'),TO_DATE('2009-01-27', 'YYYY-MM-DD'),NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 9:00h a 13:00h',1);
...
INSERT INTO pedido VALUES (80,TO_DATE('2009-01-25', 'YYYY-MM-DD'),TO_DATE('2009-01-26', 'YYYY-MM-DD'),NULL,'Pendiente','No terminó el pago',28);
...
INSERT INTO pedido VALUES (90,TO_DATE('2009-02-07', 'YYYY-MM-DD'),TO_DATE('2008-02-17', 'YYYY-MM-DD'),NULL,'Pendiente','Debido a la nevada caída en la sierra, el pedido no podrá llegar hasta el día ',27);
INSERT INTO pedido VALUES (91,TO_DATE('2009-03-18', 'YYYY-MM-DD'),TO_DATE('2009-03-29', 'YYYY-MM-DD'),TO_DATE('2009-03-27', 'YYYY-MM-DD'),'Entregado','Todo se entregó a su debido tiempo, incluso con un día de antelación',27);
INSERT INTO pedido VALUES (92,TO_DATE('2009-04-19', 'YYYY-MM-DD'),TO_DATE('2009-04-30', 'YYYY-MM-DD'),TO_DATE('2009-05-03', 'YYYY-MM-DD'),'Entregado','El pedido se entregó tarde debido a la festividad celebrada en España durante esas fechas',27);
INSERT INTO pedido VALUES (93,TO_DATE('2009-05-03', 'YYYY-MM-DD'),TO_DATE('2009-05-30', 'YYYY-MM-DD'),TO_DATE('2009-05-17', 'YYYY-MM-DD'),'Entregado','El pedido se entregó antes de lo esperado.',27);
INSERT INTO pedido VALUES (94,TO_DATE('2009-10-18', 'YYYY-MM-DD'),TO_DATE('2009-11-01', 'YYYY-MM-DD'),NULL,'Pendiente','El pedido está en camino.',27);
...
INSERT INTO pedido VALUES (114,TO_DATE('2009-01-15', 'YYYY-MM-DD'),TO_DATE('2009-01-29', 'YYYY-MM-DD'),TO_DATE('2009-01-31', 'YYYY-MM-DD'),'Entregado','El envio llego dos dias más tarde debido al mal tiempo',36);
...
INSERT INTO pedido VALUES (119,TO_DATE('2009-01-10', 'YYYY-MM-DD'),TO_DATE('2009-01-15', 'YYYY-MM-DD'),TO_DATE('2009-01-15','Entregado','El pedido llego perfectamente',16);
...
INSERT INTO pago VALUES (30,'PayPal','ak-std-000024',TO_DATE('2009-01-16','YYYY-MM-DD'),3321);
...
-- 4.	Devuelve el nombre del puesto, nombre, apellidos y email del jefe de 
-- la empresa. 
select *
from empleado
...
from pago
where to_char(fecha_pago,'YYYY') like '2008';
...
select * 
from pedido
where to_char(fecha_pedido,'YYYY') like '2009'
and upper(estado) like 'RECHAZADO';

-- 12.	Devuelve un listado de todos los pedidos que han sido entregados 
-- en el mes de enero de cualquier año. 
select * 
from pedido
where to_char(fecha_pedido, 'MM') like '01'
and upper(estado) like 'ENTREGADO';
...
from pago
where to_char(fecha_pago, 'YYYY') like '2008'
and upper(forma_pago) like 'PAYPAL';
...
select * 
from producto
where upper(gama) like 'ORNAMENTALES'
...
-- 17.	Obtén un listado con el nombre de cada cliente y el nombre y apellido 
...
-- 18.	Muestra el nombre de los clientes que hayan realizado pagos junto 
-- con el nombre de sus representantes de ventas.
select distinct(cliente.nombre_cliente), empleado.nombre, empleado.apellido1
from cliente join empleado
on cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado
join pago
...
-- 19.	Muestra el nombre de los clientes que no hayan realizado pagos junto 
-- con el nombre de sus representantes de ventas. 
select cliente.nombre_cliente, empleado.nombre, empleado.apellido1
from cliente join empleado
on cliente.codigo_empleado_rep_ventas = empleado.codigo_empleado
...
-- 20.	Devuelve el nombre de los clientes que han hecho pagos y el nombre 
...
-- 21.	Devuelve el nombre de los clientes que no hayan hecho pagos y el 
...
24.	Devuelve el nombre de los clientes a los que no se les ha entregado a tiempo un pedido. 
25.	Devuelve un listado de las diferentes gamas de producto que ha comprado cada cliente.

CONSULTAS COPOSICIÓN EXTERNA (LEFT JOIN, RIGHT JOIN)
26.	Devuelve un listado que muestre solamente los clientes que no han realizado ningún pago.
27.	Devuelve un listado que muestre solamente los clientes que no han realizado ningún pedido.
28.	Devuelve un listado que muestre los clientes que no han realizado ningún pago y los que no han realizado ningún pedido. 
29.	Devuelve un listado que muestre solamente los empleados que no tienen una oficina asociada.
30.	Devuelve un listado que muestre solamente los empleados que no tienen un cliente asociado. 
31.	Devuelve un listado que muestre solamente los empleados que no tienen un cliente asociado junto con los datos de la oficina donde trabajan. 
...
34.	Devuelve un listado de los productos que nunca han aparecido en un pedido. El resultado debe mostrar el nombre, la descripción y la imagen del producto. 
35.	Devuelve las oficinas donde no trabajan ninguno de los empleados que hayan sido los representantes de ventas de algún cliente que haya realizado la compra de algún producto de la gama Frutales. 
36.	Devuelve un listado con los clientes que han realizado algún pedido pero no han realizado ningún pago. 
37.	Devuelve un listado con los datos de los empleados que no tienen clientes asociados y el nombre de su jefe asociado.

-------------------------------------------------------------------------------
-- CONSULTAS RESUMEN

-- 38.	¿Cuántos empleados hay en la compañía? 
select count(*) from empleado;

-- 39.	¿Cuántos clientes tiene cada país? 
select pais, count(*) as clientes_totales
from cliente
group by pais;
...
select avg(total)
from pago
where to_char(fecha_pago,'YYYY') like '2009';

-- 41.	¿Cuántos pedidos hay en cada estado? Ordena el resultado de forma 
...
-- 42.	Calcula el precio de venta del producto más caro y más barato en una 
-- misma consulta.
select min(total), max(total) from pago;

-- 43.	Calcula el número de clientes que tiene la empresa. 
select count(*) from cliente;

-- 44.	¿Cuántos clientes tiene la ciudad de Madrid? 
select count(*) from cliente
where upper(ciudad) like 'MADRID';

-- 45.	¿Calcula cuántos clientes tiene cada una de las ciudades que empiezan por M? 
select count(*)
from cliente
where upper(ciudad) like 'M%';

-- 46.	Devuelve el nombre de los representantes de ventas y el número de 
-- clientes al que atiende cada uno. 


47.	Calcula el número de clientes que no tiene asignado representante de ventas. 
48.	Calcula la fecha del primer y último pago realizado por cada uno de los clientes. El listado deberá mostrar el nombre y los apellidos de cada cliente. 
49.	Calcula el número de productos diferentes que hay en cada uno de los pedidos. 
50.	Calcula la suma de la cantidad total de todos los productos que aparecen en cada uno de los pedidos. 
51.	Devuelve un listado de los 20 productos más vendidos y el número total de unidades que se han vendido de cada uno. El listado deberá estar ordenado por el número total de unidades vendidas. 
52.	La facturación que ha tenido la empresa en toda la historia, indicando la base imponible, el IVA y el total facturado. La base imponible se calcula sumando el coste del producto por el número de unidades vendidas de la tabla detalle_pedido. El IVA es el 21 % de la base imponible, y el total la suma de los dos campos anteriores.
53.	La misma información que en la pregunta anterior, pero agrupada por código de producto.
54.	La misma información que en la pregunta anterior, pero agrupada por código de producto filtrada por los códigos que empiecen por OR. 
55.	Lista las ventas totales de los productos que hayan facturado más de 3000 euros. Se mostrará el nombre, unidades vendidas, total facturado y total facturado con impuestos (21% IVA).

-------------------------------------------------------------------------------
-- SUBCONSULTAS CON OPERADORES BÁSICOS

56.	Devuelve el nombre del cliente con mayor límite de crédito. 
57.	Devuelve el nombre del producto que tenga el precio de venta más caro. 
58.	Devuelve el nombre del producto del que se han vendido más unidades. (Tenga en cuenta que tendrá que calcular cuál es el número total de unidades que se han vendido de cada producto a partir de los datos de la tabla detalle_pedido. Una vez que sepa cuál es el código del producto, puede obtener su nombre fácilmente.) 
59.	Los clientes cuyo límite de crédito sea mayor que los pagos que haya realizado. (Sin utilizar INNER JOIN). 
60.	Devuelve el producto que más unidades tiene en stock. 
61.	Devuelve el producto que menos unidades tiene en stock. 
62.	Devuelve el nombre, los apellidos y el email de los empleados que están a cargo de Alberto Soria.

-- CON ALL Y ANY

63.	Devuelve el nombre del cliente con mayor límite de crédito. 
64.	Devuelve el nombre del producto que tenga el precio de venta más caro. 
65.	Devuelve el producto que menos unidades tiene en stock.
...
68.	Devuelve un listado que muestre solamente los clientes que sí han realizado ningún pago.
69.	Devuelve un listado de los productos que nunca han aparecido en un pedido. 15. Devuelve el nombre, apellidos, puesto y teléfono de la oficina de aquellos empleados que no sean representante de ventas de ningún cliente. 
70.	Devuelve las oficinas donde no trabajan ninguno de los empleados que hayan sido los representantes de ventas de algún cliente que haya realizado la compra de algún producto de la gama Frutales. 
71.	Devuelve un listado con los clientes que han realizado algún pedido pero no han realizado ningún pago.

-- CON EXISTS Y NOT EXISTS

72.	Devuelve un listado que muestre solamente los clientes que no han realizado ningún pago.
73.	Devuelve un listado que muestre solamente los clientes que sí han realizado ningún pago.
74.	Devuelve un listado de los productos que nunca han aparecido en un pedido. 
75.	Devuelve un listado de los productos que han aparecido en un pedido alguna vez.

--------------------------------------------------------------------------------
-- CONSULTAS VARIADAS

-- 76.	Devuelve el listado de clientes indicando el nombre del cliente y 
-- cuántos pedidos ha realizado. Tenga en cuenta que pueden existir clientes 
-- que no han realizado ningún pedido.
select cliente.nombre_cliente, count(*) as pedidos_realizados
from cliente join pedido
on cliente.codigo_cliente = pedido.codigo_cliente
group by cliente.nombre_cliente;

-- 77.	Devuelve un listado con los nombres de los clientes y el total pagado 
...
-- 78.	Devuelve el nombre de los clientes que hayan hecho pedidos en 2008 
-- ordenados alfabéticamente de menor a mayor. 
select distinct(cliente.nombre_cliente)
from cliente join pedido
on cliente.codigo_cliente = pedido.codigo_cliente
where to_char(pedido.fecha_pedido, 'YYYY') like '2008'
order by cliente.nombre_cliente;

-- 79.	Devuelve el nombre del cliente, el nombre y primer apellido de su 
...
-- 80.	Devuelve el listado de clientes donde aparezca el nombre del cliente, 
...
-- 81.	Devuelve el nombre, apellidos, puesto y teléfono de la oficina de 
...
-- 82.	Devuelve un listado indicando todas las ciudades donde hay oficinas 
