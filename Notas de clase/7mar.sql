...
SELECT DEPART.DEPT_NO, DEPART.DNOMBRE, COUNT(*)
FROM EMPLE JOIN DEPART
ON EMPLE.DEPT_NO = DEPART.DEPT_NO
GROUP BY DEPART.DEPT_NO, DEPART.DNOMBRE
    HAVING COUNT(*) = (SELECT MAX(COUNT(*)) 
        FROM EMPLE 
        GROUP BY DEPT_NO); --! HAVING es WHERE a nivel de grupo

---------------------------------------------------------------------------------
-- Visualiza el dpto, num y nombre, que tenga mas empleados cuyo oficio sea empleado
